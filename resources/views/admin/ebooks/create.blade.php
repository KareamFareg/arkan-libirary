...
@if ($errors->any())
            ...
            @endif
                            <form action="/ebooks/insert" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker" id="select-country"  name="writer_name" data-live-search="true">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                         ...
                                         <input type="number" class="form-control" id="parts" step="1" name="parts" required="">
                                        </div>
                                     </div>     
                                     <div class="col-md-6">
                                        <div class="form-group">
                                         <label for="pages">عدد الصفحات</label>
                                         <input type="number" class="form-control" id="pages" step="1" name="pages" required="">
                                        </div>
                                     </div>     
                                    <div class="col-md-6">
                                        <div class="form-group">
