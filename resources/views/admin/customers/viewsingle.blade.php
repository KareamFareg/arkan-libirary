                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$singleorder->items}}<span>عناصر</span></td>
                                            <td>
                                                <ul class="d-flex p-0">
                                                    <li class="mr-3"><a href="/dashboard/orders/order_details/{{$singleorder->id}}" class="btn-icon btn-inverse-info"><i class="feather ft-eye"></i></a></li>
