                            ...
                            <div class="form-row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{$content->name}}" class="form-control" id="validationCustom01" placeholder=" عنوان الكتاب" required="">
                                        <input type="HIDDEN" name="id" value="{{$content->id}}" class="form-control" id="validationCustom01" placeholder=" عنوان الكتاب" required="">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" required>
                                                ...
                                                <option value="1" selected>مستعمل</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="publisher_id" class="form-control" required>
                                                ...
                                                @if($content->publisher_id==$singlepublisher->id)
                                                <option value="{{$singlepublisher->id}}" selected>{{$singlepublisher->name}}</option>
                                                @else
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class=""> المؤلف</label>
                                            ...
                                            <option value="">اختر المؤلف</option>
                                                ...
                                                @if($content->writer_id==$singlewriter->id)
                                                <option value="{{$singlewriter->id}}" selected>{{$singlewriter->name}}</option>
                                                @else
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="country_id" id="country_id" onchange="getCitydata()" class="form-control" required>
                                                ...
                                                @if($content->country_id==$singlecountry->id)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="city" id="city" class="form-control" required>
                                                ...
                                                @if($content->city_id==$singlecity->id)
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                        ...
                                        <input type="text" name="address" value="{{$content->address}}" class="form-control" id="validationCustom01" placeholder=" العنوان" required="">
                                       </div>
                                    </div>
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="cat" id="cat" onchange="getsubcatdata()" class="form-control" required>
                                                ...
                                                @if($content->cat_id==$singlecat->id)
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach($subcats as $singlesubcat)
                                                @if($content->subcat_id==$singlesubcat->id)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                         ...
                                         <input type="number" class="form-control" value="{{$content->price}}" id="price" step="0.1" name="price" required="">
                                        </div>
                                     </div>            
                                     <div class="col-md-6">
                                        <div class="form-group">
                                         <label for="email">الخصم</label>
                                         <input type="number" class="form-control" id="discount" step="1" value="{{$content->discount}}" name="discount" required="">
                                        </div>
                                     </div>                              
                                     <div class="col-md-6">
                                        <div class="form-group">
                                         <label for="email">الكمية</label>
                                         <input type="number" class="form-control" id="quantity" value="{{$content->quantity}}" step="1" name="quantity" required="">
                                        </div>
                                     </div> 
                                      <div class="col-md-6">
                                        <div class="form-group">
                                         <label for="email">عدد الصفحات</label>
                                         <input type="number" class="form-control" id="numpg" value="{{$content->numpg}}" step="1" name="numpg" required="">
                                        </div>
                                     </div> 
                                     <div class="col-md-6">
                                        <div class="form-group">
                                         <label for="email"> مقاس الكتاب</label>
                                         <input type="text" class="form-control" id="booksize" value="{{$content->booksize}}" name="booksize" required="">
                                        </div>
                                     </div>  
                                     <div class="col-md-6">
                                        <div class="form-group">
                                         <label for="email">تنبيه او ملاحظه</label>
                                         <input type="text" class="form-control" id="notes" value="{{$content->notes}}" name="notes" >
                                        </div>
                                     </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                         <label for="phone">تفاصيل</label>
                                         <textarea class="form-control" id="details" name="details" value="{{$content->details}}">{{$content->details}}</textarea>
                                        </div>
                                     </div>
                                      <div class="col-md-12">
                                        <div class="form-group">
